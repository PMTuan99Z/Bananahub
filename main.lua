...
ImageButton.Image = "http://www.roblox.com/asset/?id=17347777526"
...
local listfastattack = {'Slow','Normal','Extra','Fast','Speed'}
	...
	if _G.FastAttackHiruHub_Mode == "SPEED" then
		_G.Fast_Delay = 0.1
	elseif _G.FastAttackHiruHub_Mode == "Fast" then
		_G.Fast_Delay = 0.5	
	elseif _G.FastAttackHiruHub_Mode == "Extra" then
		_G.Fast_Delay = 0.15
    elseif _G.FastAttackHiruHub_Mode == "Nomal" then
        _G.Fast_Delay = 0.175	
	elseif _G.FastAttackHiruHub_Mode == "Slow" then
		_G.Fast_Delay = 0.12
	end
end)
