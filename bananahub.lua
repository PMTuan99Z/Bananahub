...
local listfastattack = {'Slow','Normal','Extra','Fast','Speed'}
    ...
    DropdownDelayAttack:SetValue("Fast")
    DropdownDelayAttack:OnChanged(function(Value)
    _G.FastAttackHiruHub_Mode = Value
	if _G.FastAttackHiruHub_Mode == "Slow" then
		_G.Fast_Delay = 0.7
	elseif _G.FastAttackHiruHub_Mode == "Normal" then
		_G.Fast_Delay = 0.12	
	elseif _G.FastAttackHiruHub_Mode == "Extra" then
		_G.Fast_Delay = 0.5
    elseif _G.FastAttackHiruHub_Mode == "Fast" then
        _G.Fast_Delay = 0.1	
	elseif _G.FastAttackHiruHub_Mode == "Speed" then
		_G.Fast_Delay = 0
	end
end)
...
endlocal boss = Tabs.Main:AddSection("Boss Farm")
...
spawn(function()
    ...
    end)local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "Tp Collect Devil Fruit Spam",Description = "", Default = false })
